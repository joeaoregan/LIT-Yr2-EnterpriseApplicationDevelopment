...
// Schedule Location Row (schedule_location)     
                out.println("<tr><th>Location:</th>" +
                                "<td><select id=\"schedule_location\" name=\"schedule_location\" title=\"Select A Location From The List\">");
                                    ...
                                    out.println("</select></td></tr>");
// Submit Button Row
                out.println("<tr><td colspan=\"2\"  id=\"bt\"><input type=\"submit\" value=\"Submit\" title=\"Submit Details\"/></td></tr></table></form><br>");
                out.println("<p>* Only <b>available</b> time slots can be selected</p></div><br>");
