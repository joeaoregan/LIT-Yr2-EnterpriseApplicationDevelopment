...
"                           <link rel=\"stylesheet\" type=\"text/css\" href=\"CAstyle.css\">");
            out.println("<title>Servlet in_schedule</title>");            
            out.println("</head>");
            out.println("<body>"
                        + "<div class=\"heading\">\n" +
"                           <br><h1 style=\"text-align:center\">Schedule Details</h1><br>\n" +
                ...
                "            <form style=\"display: inline\" action=\"in_schedule.html\" method=\"get\"><button name=\"buttonSchedule\" title=\"Add Schedule Details (Alt + 3)\">Add Schedule Details</button></form>\n" +
                ...
                "        </div>"
                    ...
                    try{
                        ...
                        //{
                            ...
                            while(schedule.next())
                            {
                                scheduletime = schedule.getString("schedule_time");  
                                schedulelocation = schedule.getString("schedule_location");
                                //if (scheduletime.contentEquals("08:00:00")) slot800 = "disabled";
                                //if (scheduletime.contentEquals("08:30:00")) slot830 = "disabled";
                                for(int i = 0; i <20; i++)
                                {
                                    if (scheduletime.contentEquals(times[i])) status[i] = "disabled"; // If the time is already in the schedule, disable to prevent double booking
                                }
                ...
                "                        <th>Workshop:</th>\n");
                 ...
                 try{
                        ...
                        //ResultSet speaker = stmt.executeQuery("SELECT speaker_id,speaker_fname,speaker_lname from Speakers");
                            ...
                            while(workshop.next())
                            {
                                workshop_name = workshop.getString("workshop_name");
                ...
                "            <a href=\"in_schedule.html\" title=\"Add Schedule Details (Alt + 3)\" accesskey=\"3\">3. Add Schedule Details</a><br>" +
