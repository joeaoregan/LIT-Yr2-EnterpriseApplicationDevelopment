...
// Navigation menu
            out.println("<div class=\"navigation\">" +
                            ...
                            "<form id=\"navm\" action=\"reg_admin.html\" method=\"get\"><button name=\"buttonRegAdmin\" title=\"Administrator Registration Page (Alt + 5)\">Administrator Registration</button></form>" +
...
// Current Workshops            
            out.println("<div class=\"mainbody\">" +
                            "<table align=\"center\">" +
                                ...
                                "<tr><td colspan=\"4\">A list of the workshops currently scheduled:</td></tr>" +
                                "<tr><td colspan=\"4\">&nbsp;</td></tr>");                    
            try {
                java.sql.Statement stmt = conn.createStatement();
                ...
                //out.println("<tr><th>Presenter 1:</th><td>"+ws_pres1+"</td><th>Presenter 2:</th><td>"+ws_pres2+"</td></tr>");            // presenter names
...
// Navigation menu
            out.println("<div class=\"navigation\">" +
                        ...
                        "<form style=\"display: inline\" action=\"show_workshops\" method=\"get\"><button style=\"color: blue; background-color: white;\" name=\"buttonWorkshops\" title=\"Event Workshops (Alt + 2)\">Event Workshops</button></form>" +
